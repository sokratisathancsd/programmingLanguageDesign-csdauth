...
_lr_signature = 'leftPLUSMINUSleftMULDIVIDEDIVIDE EQUALS FLOAT INT MINUS MUL NAME PLUS\n    calc : expression\n         | var_assign\n         | empty\n    \n    var_assign : NAME EQUALS expression\n    \n    expression : expression MUL expression\n               | expression DIVIDE expression\n               | expression PLUS expression\n               | expression MINUS expression\n    \n    expression : INT\n               | FLOAT\n    \n    expression : NAME\n    \n    empty :\n    '
...
_lr_productions = [
  ...
  ('expression -> expression MUL expression','expression',3,'p_expression','calc.py',86),
  ('expression -> expression DIVIDE expression','expression',3,'p_expression','calc.py',87),
  ('expression -> expression PLUS expression','expression',3,'p_expression','calc.py',88),
  ('expression -> expression MINUS expression','expression',3,'p_expression','calc.py',89),
  ...
  ('expression -> NAME','expression',1,'p_expression_var','calc.py',103),
